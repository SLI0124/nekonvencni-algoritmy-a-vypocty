...
class PoleBalancingApp:
    def __init__(self, root):
        ...
        self.max_steps = 500
        self.total_steps = 500  # nový atribut pro celkový počet kroků (nastavitelný)
        self.canvas = None
        self.status_text = None
        self.visualize_btn = None
        self.stop_train_btn = None
        self.train_btn = None
        self.batch_entry = None
        self.episodes_entry = None
        self.save_anim_btn = None
        self.create_widgets()
